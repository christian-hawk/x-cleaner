...
> **Note**: For code style, naming conventions, and quality standards, see [CODE_CONVENTIONS.md](./CODE_CONVENTIONS.md)
...
For detailed code style guidelines, naming conventions, Clean Code principles, and quality standards, see:

**[CODE_CONVENTIONS.md](./CODE_CONVENTIONS.md)**

Key topics covered:
- Clean Code Principles (DRY, self-documenting code)
- Code size limits (files, functions, complexity)
- PEP 8 style guide
- Naming conventions (mandatory self-explanatory names)
- Forbidden patterns (abbreviations, single letters, vague names)
- Docstring format
